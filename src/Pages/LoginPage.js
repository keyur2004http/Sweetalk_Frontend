        ...
        <form onSubmit={handleLogin} autoComplete="off" className="space-y-6">
          <div>
            ...
            <input
              ...
              id="username"
              autoComplete="off"
              className={`w-full px-4 py-3 rounded-xl bg-gray-50 border transition-all outline-none focus:ring-4 focus:ring-blue-100 ${errors.username ? 'border-red-500' : 'border-gray-200 focus:border-blue-500'
                }`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl bg-gray-50 border transition-all outline-none focus:ring-4 focus:ring-blue-100 ${errors.password ? 'border-red-500' : 'border-gray-200 focus:border-blue-500'
                }`}
              placeholder="••••••••"
              value={password}
